    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4 overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div style={{
          ...
          background: 'radial-gradient(ellipse 70% 55% at 80% 0%, rgba(38,95,68,0.20) 0%, rgba(22,65,45,0.09) 40%, transparent 70%)',
        }} />
        <div style={{
          position: 'absolute', inset: 0,
        ...
        >
          <div
            ...
            style={{
              ...
              boxShadow: '0 0 20px rgba(168,201,64,0.20)',
            }}
          >
            ...
            >
              <div className="relative flex items-center justify-center py-2">
                <motion.div
                  ...
                  style={{ background: 'radial-gradient(circle, rgba(168,201,64,0.28) 0%, transparent 70%)' }}
                />
                <div
