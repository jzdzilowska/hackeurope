...
const TYPE_META = {
  ...
  subscription: { icon: CreditCard,   color: '#5B9BD5', bg: 'rgba(91,155,213,0.08)',   label: 'Subscription' },
            ...
            <div className="relative flex items-center justify-center mb-4">
              <svg width="100" height="100" className="-rotate-90">
                ...
                <motion.circle
                  cx="50" cy="50" r="42"
                  fill="none"
                  stroke={healthScore >= 70 ? '#3DBF7A' : healthScore >= 50 ? '#FBBF24' : '#F87171'}
                  strokeWidth="7"
                  strokeLinecap="round"
        ...
        <div className="card p-5">
          ...
          <ResponsiveContainer width="100%" height={180}>
            <AreaChart data={RUNWAY_DATA} margin={{ top: 4, right: 4, left: -20, bottom: 0 }}>
              ...
              />
              <Area type="monotone" dataKey="cash" stroke="#5B9BD5" strokeWidth={2}
